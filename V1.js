            ...
            dataSets: [
              {
                timeSeriesQuery: {
                  timeSeriesFilter: {
                    filter: 'metric.type="dataflow.googleapis.com/job/worker/physical_cpu_utilization" AND resource.type="dataflow_job"',
                    aggregation: {
                      alignmentPeriod: "60s",
                      perSeriesAligner: "ALIGN_MEAN",
                    },
            ...
            dataSets: [
              {
                timeSeriesQuery: {
                  timeSeriesFilter: {
                    filter: 'metric.type="dataflow.googleapis.com/job/worker/memory_utilization" AND resource.type="dataflow_job"',
                    aggregation: {
                      alignmentPeriod: "60s",
                      perSeriesAligner: "ALIGN_MEAN",
                    },
            ...
            dataSets: [
              {
                timeSeriesQuery: {
                  timeSeriesFilter: {
                    filter: 'metric.type="dataflow.googleapis.com/job/step/execution_time" AND resource.type="dataflow_job"',
                    aggregation: {
                      alignmentPeriod: "60s",
                      perSeriesAligner: "ALIGN_MEAN",
                    },
            ...
            dataSets: [
              {
                timeSeriesQuery: {
                  timeSeriesFilter: {
                    filter: 'metric.type="dataflow.googleapis.com/job/autoscaling/num_vms" AND resource.type="dataflow_job"',
                    aggregation: {
                      alignmentPeriod: "60s",
                      perSeriesAligner: "ALIGN_MEAN",
                    },
